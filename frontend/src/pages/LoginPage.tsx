              ...
              <div className="space-y-1.5">
                ...
                <div className="relative">
                  ...
                  <Button
                    ...
                    className="absolute right-1.5 top-1/2 -translate-y-1/2 text-muted-foreground/75 hover:text-foreground transition-colors h-8 w-8 hover:bg-transparent p-0"
                  >
                    {showPassword ? (
